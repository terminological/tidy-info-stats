...
#' @export
calculateDiscreteDiscreteMI =  function(df, groupXVar, groupYVar, method="Grassberger", ...) {
...
#' @export
calculateDiscreteDiscreteMI_Empirical = function(df, groupXVar, groupYVar, ...) {
  df %>% probabilitiesFromGroups({{groupXVar}}, {{groupYVar}}) %>% calculateMultiClassMI()
}
